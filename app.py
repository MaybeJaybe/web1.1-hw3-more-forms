...
def animal_facts():
    ...
    chose_animal = request.args.get('animal_list')
    animal_facts = None

    if chose_animal != None:
        animal_facts = animal_to_fact[chose_animal]

    context = {
        'animal_list': animal_list,
        'chose_animal': chose_animal,
